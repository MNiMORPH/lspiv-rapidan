...
| 2 | `bearing_deg_cwN` | degrees | Flow bearing, clockwise from north (0° = north, 90° = east) |
| 3 | `v_x_m_s` | m/s | Eastward velocity component |
| 4 | `v_y_m_s` | m/s | Northward velocity component |
